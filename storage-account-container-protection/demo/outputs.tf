...
output "demo_storage_account_name"{
  value = azurerm_storage_account.quick_scan_storage_account.name
  description = "Deployed quick scan demo storage account name"
}

output "demo_storage_container_name"{
  value = azurerm_storage_container.quick_scan_storage_container.name
  description = "Deployed quick scan demo storage account name"
}
...
output "storage_account_key" {
  value = azurerm_storage_account.quick_scan_storage_account.primary_access_key
